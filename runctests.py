...
def run_tests(verbose=False):
    # Find all .mem files in the build directory recursively
    mem_files = glob.glob("c_tests/*.mem", recursive=True)

    if not mem_files:
        print("No .mem files found in the build directory.")
        return
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run C tests.")
